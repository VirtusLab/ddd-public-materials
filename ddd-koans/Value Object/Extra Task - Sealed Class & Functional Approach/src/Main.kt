sealed class TimeSignature {
    companion object {
        ...
        fun create(numberOfBeats: Int, denominator: Int): TimeSignature =
            runCatching { ValidTimeSignature(NumberOfBeats(numberOfBeats), Denominator(denominator)) }
...
data class ValidTimeSignature(private val numberOfBeats: NumberOfBeats, private val denominator: Denominator) : TimeSignature()
